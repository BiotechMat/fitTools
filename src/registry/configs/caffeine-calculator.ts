...
export const caffeineConfig: ToolConfig = {
  ...
  faq: [
    ...
    },
    {
      ...
      a: "Typically 80 to 120 mg per single espresso-based drink and 60 to 100 mg per instant cup, with large brewed coffees often exceeding 200 mg. Energy drinks usually carry 80 to 160 mg per can.",
    },
    {
    ...
    },
    {
      ...
      a: "Moderate intake (up to ~400 mg/day for healthy adults, per EFSA's assessment) is considered safe for most people. Pregnancy and heart conditions change that calculus, so ask your doctor.",
    },
  ],
