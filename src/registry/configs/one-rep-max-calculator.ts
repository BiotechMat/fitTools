...
export const oneRmConfig: ToolConfig = {
  ...
  metaDescription:
    "Free 1RM calculator using the Epley, Brzycki, Lombardi and O'Conner formulas, with a 50 to 95% of 1RM loading table for programming your training.",
  hub: "strength",
  tier: 1,
  ...
  faq: [
    ...
    },
    {
      ...
      a: "Most strength programmes prescribe working sets as a percentage of 1RM, for example 5 reps at 75 to 85%. Read your estimated max, then take the row for the percentage your programme calls for.",
    },
    {
      q: "Why does my estimate differ between exercises?",
      a: "Rep-to-max relationships vary by lift and by lifter, and deadlifts in particular are commonly underestimated by prediction equations. Calibrate against how each lift actually feels rather than transferring one lift's estimate to another.",
    },
  ],
