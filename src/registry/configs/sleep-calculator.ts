  ...
  faq: [
    {
      ...
      a: "Five 90-minute cycles (7.5 hours of sleep) suits most adults, aligning with the widely recommended 7 to 9 hours. Four cycles is a short night to use sparingly; six is a full night many people do best on.",
    },
    {
    ...
    },
    {
      ...
      a: "Most people take around 10 to 20 minutes to fall asleep, so the tool subtracts an extra 15 minutes so your first full cycle starts once you're actually asleep. If you routinely drop off faster or slower, shift the suggested bedtime accordingly.",
    },
    {
