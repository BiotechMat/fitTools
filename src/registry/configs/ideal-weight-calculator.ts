  ...
  faq: [
    {
      ...
      a: "There is no single scientific 'ideal' weight. This tool reports the range produced by four historical formulas (Devine, Robinson, Miller and Hamwi), which typically spread across several kilograms for the same height — that spread is itself the honest answer.",
    },
    {
