...
export const bmrConfig: ToolConfig = {
  ...
  faq: [
    {
      q: "What is BMR?",
      a: "Basal metabolic rate is the energy your body uses at complete rest for basic functions such as breathing, circulation and cell maintenance. It typically makes up 60 to 75% of the calories most people burn in a day.",
    },
    {
