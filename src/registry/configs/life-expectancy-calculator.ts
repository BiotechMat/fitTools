...
export const lifeExpectancyConfig: ToolConfig = {
  ...
  metaDescription:
    "How five healthy-lifestyle factors related to life expectancy at 50 in the landmark Li 2018 study: people with all five lived, on average, 12 to 14 years longer than those with none. Population association, not a prediction.",
  hub: "recovery",
  tier: 2,
  ...
  faq: [
    ...
    },
    {
      ...
      a: "Never smoking; a BMI of 18.5 to 24.9; at least 30 minutes a day of moderate-to-vigorous activity; moderate alcohol intake (5 to 15 g/day for women, 5 to 30 g/day for men); and a diet-quality score in the top 40%. They come directly from the Li et al. 2018 study.",
    },
    {
