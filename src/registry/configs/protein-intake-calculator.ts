...
export const proteinIntakeConfig: ToolConfig = {
  ...
  metaDescription:
    "Free protein intake calculator: daily grams from the evidence-based g/kg ranges, 1.6 to 2.2 for building muscle (Morton 2018), 1.8 to 2.0 in a cut, 1.2 to 1.5 for older adults, plus a per-meal split.",
  hub: "nutrition",
  tier: 2,
  ...
  faq: [
    {
      ...
      a: "It depends on the goal. The RDA of 0.8 g per kg of body weight is a sedentary minimum. For people who train, the ISSN position stand recommends 1.4 to 2.0 g/kg; for maximising muscle gain the meta-analytic estimate is about 1.6 g/kg with an upper confidence bound of 2.2 g/kg.",
    },
    {
      q: "Do I need more protein when cutting?",
      a: "Usually yes. During an energy deficit, higher intakes of roughly 1.8 to 2.0 g/kg help preserve lean mass while fat is lost, protein is the last macro to cut.",
    },
    {
    ...
    },
    {
      ...
      a: "Yes, the PROT-AGE group recommends at least 1.0 to 1.2 g/kg daily for people over 65, and 1.2 to 1.5 g/kg for those who are active or recovering from illness, to counter age-related muscle loss.",
    },
  ],
  ...
  sources: [
    {
      label: "Morton RW, et al. A systematic review, meta-analysis and meta-regression of protein supplementation on resistance training to induced gains. Br J Sports Med 2018;52:376-384",
