...
export const cgmConfig: ToolConfig = {
  ...
  faq: [
    ...
    },
    {
      ...
      a: "The international consensus target for many people with diabetes is at least 70% of readings between 3.9 and 10.0 mmol/L (70–180 mg/dL). Targets are individual and set with your clinician — this tool reports the number, it doesn't prescribe a goal.",
    },
    {
      q: "What does %CV tell me?",
      a: "The coefficient of variation measures how much your glucose swings around its average. The consensus stability threshold is below 36% — lower means steadier glucose. It is reported alongside the average because two people with the same average can have very different variability.",
    },
    {
