...
export const heartAgeConfig: ToolConfig = {
  ...
  faq: [
    ...
    },
    {
      ...
      a: "They don't enter the PREVENT risk maths, because the equations were not built with them as inputs, so folding them in would be inventing a number. Instead, if you know your ApoB or Lp(a) we show them separately against general reference thresholds, as useful context to raise with your doctor.",
    },
    {
