...
export const mk677Page: PeptidePage = {
  ...
  valueLine:
    "An orally-active GH secretagogue with genuine trial data, one that raised hormones and lean mass but not function, and was never approved.",
  ...
  faq: [
    ...
    },
    {
      ...
      a: "It reliably raises GH and IGF-1 to more youthful levels, and a two-year trial in healthy older adults increased fat-free mass by about 1.1 kg. But that same trial found no improvement in strength or function, and it is not an approved medicine, and the hormone changes did not translate into the benefits people assume.",
    },
    {
