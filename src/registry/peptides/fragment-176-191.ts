...
export const fragment176191Page: PeptidePage = {
  ...
  faq: [
    ...
    },
    {
      ...
      a: "It is a short fragment corresponding to the tail end (amino acids 176 to 191) of the human growth-hormone molecule, designed to mimic GH's fat-metabolism effects without its other actions. In practice, the hoped-for fat-loss effect did not hold up in the pivotal human trial.",
    },
    {
      q: "Is it safe?",
