...
export const referenceTablePages: ReferenceTablePage[] = [
  {
    ...
    howToRead:
      "Find your age, read across for each zone's beats-per-minute range. Zone 2 is the comfortable, conversational aerobic band most endurance work should live in; zones 4 to 5 are hard intervals. For a personalised version that can also use your resting heart rate (the Karvonen method), use the calculator.",
    view: "hr-zones",
  ...
  },
  {
    ...
    intro:
      "For building or keeping muscle, roughly 1.6 to 2.2 g of protein per kg of bodyweight per day is well supported. This chart gives the daily grams at the low, middle and high end of that range for a range of bodyweights.",
    howToRead:
