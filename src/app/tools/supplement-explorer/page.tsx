...
export const metadata: Metadata = {
  ...
  description:
    "Every supplement we cover, laid out by evidence tier: well-supported, preliminary, or unproven. Search the shelf, read the honest one-liner, pull the full cited review.",
